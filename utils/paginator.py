...
class Paginator(discord.ui.View):
    ...
    def update_styles(self, **kwargs):
        ...
        self.first_page_button.emoji = kwargs.get('first_button_emoji') or '<:MekoArrowLeft:1324414421933621361>'
        self.previous_page_button.emoji = kwargs.get(
            'previous_button_emoji') or '<:left_icons:1322836500315897886>'
        self.next_page_button.emoji = kwargs.get('next_button_emoji') or '<:right_icons:1322836503243653120>'
        self.last_page_button.emoji = kwargs.get('last_button_emoji') or '<:MekoArrowRight:1324414179658039389>'
        self.stop_button.emoji = kwargs.get(
            'stop_button_emoji') or '<:bin:1322836099550281849>'
