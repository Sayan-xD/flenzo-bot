...
class SnipeView(discord.ui.View):
    ...
    async def send_snipe_embed(self, interaction: discord.Interaction):
        ...
        embed.description = (
            f"<:roledranzer:1381158073262932028> **Author:** **[{display_name}](https://discord.com/users/{uid})**\n"
            f"<:icons_id:1381317053172154511> **Author ID:** `{snipe['author_id']}`\n"
            f"<:icon_mention:1381315815290179765> **Author Mention:** <@{snipe['author_id']}>\n"
            f"<:Vanity_Roles:1383631102887067688> **Deleted:** <t:{snipe['deleted_at']}:R>\n"
        )

        if snipe['content']:
            embed.add_field(name="<:bin:1382167643196227658> **Content:**", value=snipe['content'])
        if snipe['attachments']:
            attachment_links = "\n".join([f"[{attachment['name']}]({attachment['url']})" for attachment in snipe['attachments']])
            embed.add_field(name="<:media:1383630483258347551> **Attachments:**", value=attachment_links)
    ...
    @discord.ui.button(emoji="<:left_icons:1322836500315897886>", style=discord.ButtonStyle.secondary, custom_id="previous")
    ...
    @discord.ui.button(emoji="<:bin:1322836099550281849>", style=discord.ButtonStyle.danger, custom_id="delete")
    async def delete_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.message.delete()

    @discord.ui.button(emoji="<:right_icons:1322836503243653120>", style=discord.ButtonStyle.secondary, custom_id="next")
    ...
    @discord.ui.button(emoji="<:MekoArrowRight:1324414179658039389>", style=discord.ButtonStyle.secondary, custom_id="last")
...
class Snipe(commands.Cog):
    ...
    async def snipe(self, ctx):
        ...
        embed.description = (
            ...
            f"<:MekoMention:1325353916329889867> **Author Mention:** <@{first_snipe['author_id']}>\n"
            f"<:Vanity_Roles:1383631102887067688> **Deleted:** <t:{first_snipe['deleted_at']}:R>\n"
        )

        if first_snipe['content']:
            embed.add_field(name="<:bin:1382167643196227658> **Content:**", value=first_snipe['content'])
