...
class Kick(commands.Cog):
    ...
    async def kick_command(self, ctx, member: discord.Member, *, reason: str = None):
        ...
        embed = discord.Embed(
            description=(
                f"**<:roledranzer:1381158073262932028> Target User:** [{member}](https://discord.com/users/{member.id})\n"
                f"<:icon_mention:1381315815290179765> **User Mention:** {member.mention}\n"
                f"<:Vanity_Roles:1383631102887067688> **Reason:** {reason}\n"
                f"<:rp_arrow:1383632907267997716> **DM Sent:** {dm_status}"
            ),
            color=self.color
        )
