...
async def do_removal(ctx, limit, predicate, *, before=None, after=None):
  ...
  if len(to_send) > 2000:
      await ctx.send(f"<:IconTick:1381245157759782975> | Successfully removed {deleted} messages.", delete_after=3)
  else:
...
class Message(commands.Cog):
  ...
  @clear.command(name="emoji", aliases=["emojis","e","emo"], help="Clears the messages having emojis")
  @blacklist_check()
  @ignore_check()
  @commands.cooldown(1, 3, commands.BucketType.user)
  @commands.has_permissions(manage_messages=True)
  ...
  async def _reactions(self, ctx, search=100):
        ...
        await ctx.success(f"<:IconTick:1381245157759782975> | Successfully removed {total_reactions} reactions.")
