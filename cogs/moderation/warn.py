...
class Warn(commands.Cog):
    ...
    async def warn(self, ctx, user: discord.Member, *, reason=None):
        ...
        try:
            ...
            embed = discord.Embed(description=f"**<:roledranzer:1381158073262932028> Target User:** [{user}](https://discord.com/users/{user.id})\n"
                                              ...
                                              f"**<:rp_arrow:1383632907267997716> Reason:** {reason_to_send}\n"
                                              f"**<:Vanity_Roles:1383631102887067688> Total Warns:** {total_warns}",
                                              color=self.color)
    ...
    async def clearwarns(self, ctx, user: discord.Member):
        try:
            ...
            embed = discord.Embed(description=f"<:IconTick:1381245157759782975>  | All warnings have been cleared for **{user}** in this guild.", color=self.color)
