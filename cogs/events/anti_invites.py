        ...
        if self.invite_pattern.search(message.content):
            ...
            try:
                ...
                try:
                    ...
                    simple_embed.description = f"<:IconTick:1381245157759782975> | {user.mention} has been successfully **{action_taken}** for **posting an invite link.**"
                    simple_embed.set_thumbnail(url="")
