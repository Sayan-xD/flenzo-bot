...
class Voice(commands.Cog):
    ...
    @commands.group(name="voice", invoke_without_command=True, aliases=['help voice'])
    @blacklist_check()
    @ignore_check()
    ...
    async def _kick(self, ctx, *, member: discord.Member):
        ...
        embed2 = discord.Embed(title="<:IconTick:1381245157759782975> Success",
    ...
    async def vcunmute(self, ctx, *, member: discord.Member):
        ...
        if member.voice.mute == False:
            embed2 = discord.Embed(title="<:icon_cross:1381448030481547315> Error",
            ...
            return await ctx.reply(embed=embed2)
        ch = member.voice.channel.mention
        embed3 = discord.Embed(title="<:IconTick:1381245157759782975> Success",
    ...
    async def _moveall(self, ctx, *, channel: discord.VoiceChannel):
        ...
        try:
            ...
            embed3 = discord.Embed(title="<:icon_cross:1381448030481547315> Error",
