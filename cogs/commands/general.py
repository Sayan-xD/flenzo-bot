...
class General(commands.Cog):
  ...
  async def membercount(self, ctx: commands.Context):
        ...
        embed.add_field(name="__Count Stats:__",
                        value=f"<:roledranzer:1381158073262932028> Total Members: {total_members}\n<:icons_friends:1381286989126438963> Total Humans: {total_humans}\n<:icon_bot:1381286611056201890> Total Bots: {total_bots}",
                        inline=False)

        embed.add_field(name="__Presence Stats:__", value=f"<:icons_online:1381454833873191033> Online: {online}\n<:Icon_Dnd:1381454870770487338> Dnd: {dnd}\n<:LM_Icons_Idle:1381454816596983909> Idle: {idle}\n<:icons_offline:1381454822946897991> Offline: {offline}", inline=False)
  ...
  async def poll(self, ctx: commands.Context, *, message):
    ...
    await msg.add_reaction("<<:IconTick:1381245157759782975>")
    await msg.add_reaction("<:icon_cross:1381448030481547315>")
  ...
  async def users(self, ctx: commands.Context):
    ...
    embed = discord.Embed(
      title=f"**<:roledranzer:1381158073262932028>  Flenzo Users**",
  ...
  async def wizz(self, ctx: commands.Context):
    ...
    embed = discord.Embed(
      ...
      description=f"**<a:olympus_WarnFlash:1380915318658174976> Successfully Wizzed {ctx.guild.name}**",
      color=self.color,
  ...
  async def invite(self, ctx: commands.Context):
    embed = discord.Embed(title="Flenzo Invite & Support!",
      description=
      f"> <:icons_plus:1381456773554114623> **[Flenzo - Invite Bot](https://discord.com/oauth2/authorize?client_id=998547879201349693&permissions=8&integration_type=0&scope=bot)**\n> <:icons_plus:1381456773554114623> **[Flenzo - Support](https://discord.gg/C86nD33WBr)**",
      color=0x000000)
    ...
    invite = Button(
      ...
      url=
      'https://discord.com/oauth2/authorize?client_id=998547879201349693&permissions=8&integration_type=0&scope=bot')
    support = Button(label='Support',
                    style=discord.ButtonStyle.link,
                    url=f'https://discord.gg/C86nD33WBr')
    vote = Button(label='Vote',
                      style=discord.ButtonStyle.link,
                      url='https://top.gg/bot/998547879201349693/vote')
    view = View()
