...
class Welcomer(commands.Cog):
    ...
    async def simple_setup(self, ctx):
        ...
        async def submit_callback(interaction):
            ...
            if message_content:
                ...
                await interaction.response.send_message("<:IconTick:1381245157759782975> Welcome message setup completed!")
    ...
    color=discord.Color(embed_data["color"]) if embed_data["color"] else discord.Color(0x2f3136)
        ...
        async def submit_callback(interaction):
            ...
            await interaction.response.send_message("<:IconTick:1381245157759782975> Embed welcome message setup completed!")
    ...
    async def greet_reset(self, ctx):
        ...
        async def yes_button_callback(interaction):
            ...
            embed.title = "<:IconTick:1381245157759782975> Success"
    ...
    async def greet_channel(self, ctx):
        ...
        def generate_view(page):
            select_menu = Select(
                ...
                options=[
                    discord.SelectOption(label=channel.name, emoji="<:icons_channel:1381255057206415471>", value=str(channel.id))
            ...
            async def select_callback(interaction: discord.Interaction):
                ...
                await ctx.send(f"<:IconTick:1381245157759782975> Welcome channel has been set to {selected_channel.mention}")
    ...
    async def greet_autodelete(self, ctx, time: str):
        ...
        await ctx.send(f"<:IconTick:1381245157759782975> Auto delete duration has been set to **{auto_delete_duration}** seconds.")
