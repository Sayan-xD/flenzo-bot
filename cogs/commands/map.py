...
class MapView(ui.View):
    ...
    def get_coordinates(self, location):
        ...
        try:
            headers = {'User-Agent': 'Synapse Bot (https://olyumpus.vercel.app)'}
    ...
    @discord.ui.button(label="", emoji="<:Synapse_arrowLeft:1257731273938571305>", style=ButtonStyle.secondary)
    ...
    @discord.ui.button(label="",  emoji="<:Synapse_arrowUp:1257731370814537831>", style=ButtonStyle.secondary)
    ...
    @discord.ui.button(label="", emoji="<:Synapse_bin:1254336650075701308>", style=ButtonStyle.danger)
    ...
    @discord.ui.button(label="", emoji="<:Synapse_arrowDown:1257731390770909335>", style=ButtonStyle.secondary)
    ...
    @discord.ui.button(label="", emoji="<:Synapse_arrowRight:1257731310936391701>", style=ButtonStyle.secondary)
