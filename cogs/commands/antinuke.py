...
class Antinuke(commands.Cog):
  ...
  @commands.hybrid_command(name='antinuke', aliases=['antiwizz', 'anti'], help="Enable Antinuke To Protect Your Server")
    ...
    if option is None:
      ...
      if is_activated:
        ...
        setup_embed = discord.Embed(
          title="Antinuke Setup <a:geari:1380914491549548675>",
          description="<:IconTick:1381245157759782975> | Initializing Quick Setup!",
          color=0x000000
        )
        ...
        if not ctx.guild.me.guild_permissions.administrator:
          setup_embed.description += "\n<a:olympus_WarnFlash:1380915318658174976> | Setup failed: Missing **Administrator** permission."
          await setup_message.edit(embed=setup_embed)
          return

        await asyncio.sleep(1)
        setup_embed.description += "\n<:IconTick:1381245157759782975> | Checking Flenzo's role position for optimal configuration..."
        await setup_message.edit(embed=setup_embed)

        await asyncio.sleep(1)
        setup_embed.description += "\n<:IconTick:1381245157759782975> | Crafting and configuring the Flenzo Supreme role..."
        await setup_message.edit(embed=setup_embed)
        ...
        try:
          ...
          setup_embed.description += "\n<a:olympus_WarnFlash:1380915318658174976> | Setup failed: Insufficient permissions to create role."
          await setup_message.edit(embed=setup_embed)
          return
        except discord.HTTPException as e:
          setup_embed.description += f"\n<a:olympus_WarnFlash:1380915318658174976> | Setup failed: HTTPException: {e}\nCheck Guild **Audit Logs**."
          await setup_message.edit(embed=setup_embed)
          return

        await asyncio.sleep(1)
        setup_embed.description += "\n<:IconTick:1381245157759782975> | Ensuring precise placement of the Flenzo Supreme role..."
        await setup_message.edit(embed=setup_embed)
        try:
          await ctx.guild.edit_role_positions(positions={role: 1})
        except discord.Forbidden:
          setup_embed.description += "\n<a:olympus_WarnFlash:1380915318658174976> | Setup failed: Insufficient permissions to move role."
          await setup_message.edit(embed=setup_embed)
          return
        except discord.HTTPException as e:
          setup_embed.description += f"\n<a:olympus_WarnFlash:1380915318658174976> | Setup failed: HTTPException: {e}."
        ...
        await asyncio.sleep(1)
        setup_embed.description += "\n<:IconTick:1381245157759782975> | Safeguarding your changes..."
        await setup_message.edit(embed=setup_embed)

        await asyncio.sleep(1)
        setup_embed.description += "\n<:IconTick:1381245157759782975> | Activating the Antinuke Modules for enhanced security...!!"
        await setup_message.edit(embed=setup_embed)
        ...
        embed = discord.Embed(
          description=f"**Security Settings For {ctx.guild.name} <:Automod:1383625060652417024>**\n\nTip: For optimal functionality of the AntiNuke Module, please ensure that my role has **Administration** permissions and is positioned at the **Top** of the roles list\n\n<:Utility:1381152992052645890> __**Modules Enabled**__\n>>> <:enabled:1382315528969781300> **Anti Ban**\n<:enabled:1382315528969781300> **Anti Unban**\n<:enabled:1382315528969781300> **Anti Kick**\n<:enabled:1382315528969781300> **Anti Bot**\n<:enabled:1382315528969781300> **Anti Channel Create**\n<:enabled:1382315528969781300> **Anti Channel Delete**\n<:enabled:1382315528969781300> **Anti Channel Update**\n<:enabled:1382315528969781300> **Anti Everyone/Here**\n<:enabled:1382315528969781300> **Anti Role Create**\n<:enabled:1382315528969781300> **Anti Role Delete**\n<:enabled:1382315528969781300> **Anti Role Update**\n<:enabled:1382315528969781300> **Anti Member Update**\n<:enabled:1382315528969781300> **Anti Guild Update**\n<:enabled:1382315528969781300> **Anti Integration**\n<:enabled:1382315528969781300> **Anti Webhook Create**\n<:enabled:1382315528969781300> **Anti Webhook Delete**\n<:enabled:1382315528969781300> **Anti Webhook Update**",
          color=0x000000
        )

        embed.add_field(name='', value="<:enabled:1382315528969781300> **Anti Prune**\n<:enabled:1382315528969781300> **Auto Recovery**")

        embed.set_author(name="Flenzo Antinuke", icon_url=self.bot.user.avatar.url)

        embed.set_footer(text="Success Fully Enabled Antinuke for this server | Powered by Flenzo Development™", icon_url=self.bot.user.avatar.url)
        embed.set_thumbnail(url=self.bot.user.avatar.url)
