...
class Fun(commands.Cog):
  ...
  async def mydog(self, ctx, user: discord.User):
      processing= await ctx.reply("<a:buffering:1380933192453984358> Processing Image...")
  ...
  async def howgay(self, ctx, *, person):
    embed = discord.Embed(title="<:gay:1381248411273007224> About your gayness", color=discord.Color.random())
  ...
  async def lesbian(self, ctx, *, person):
    embed = discord.Embed(title="<:lesbian:1381248683433000993> Lesbian Meter", color=discord.Color.random())
    responses = random.randrange(1, 150)
    embed.description = f'**{person} is {responses}% Lesbian** <:lesbian:1381248683433000993>'
  ...
  async def chutiya(self, ctx, *, person):
    embed = discord.Embed(title="<:chumtiya:1381249180600635492> About your Chumtiyapa", color=discord.Color.random())
    responses = random.randrange(1, 150)
    embed.description = f'**Abe {person} to {responses}% Chootiya Ha** 😂'
  ...
  async def tharki(self, ctx, *, person):
    embed = discord.Embed(title="<a:tharkinazar:1381249530107793518> About your Tharkipan", color=discord.Color.random())
    responses = random.randrange(1, 150)
  ...
  async def horny(self, ctx, *, person):
    embed = discord.Embed(title="<:hornymf:1381249805124370614> About your horniness", color=discord.Color.random())
    responses = random.randrange(1, 150)
  ...
  async def cute(self, ctx, *, person):
    embed = discord.Embed(title="<a:cute:1381250088856326245>  About your cuteness", color=discord.Color.random())
    responses = random.randrange(1, 150)
  ...
  async def intelligence(self, ctx, *, person):
    embed = discord.Embed(title="<:bigbrain:1381251084177244160>  About your intelligence", color=discord.Color.random())
    responses = random.randrange(1, 150)
    embed.description = f'**{person} has an IQ of {responses}%** <a:math:1381252241150836867>'
      ...
      try:
        async with session.get(f"http://ip-api.com/json/{ip}") as response:
          ...
          embed = discord.Embed(
            ...
            description=(
              f"\n"
              f"<a:globe:1381252539269255259> __**Location Info:**__ \n"
              f"IP: **{query}**\n"
              ...
              f"\n"
              f"<:timezone:1381252829410492579> __**Timezone Info:**__\n"
              f"Timezone: {timezone}\n"
              f"Offset: {offset}\n"
              f"\n"
              f"<a:network:1381253088186204260>  __**Network Info:**__ \n"
              f"ISP: **{isp}**\n"
              f"Organization: {organization}\n"
              f"AS: **{asn}**\n"
              f"AS Name: **{asname}**\n"
              f"\n"
              f"<a:olympus_WarnFlash:1380915318658174976> __**Miscellaneous Info:**__ \n"
              f"Mobile: {mobile}\n"
              f"Proxy: {proxy}\n"
              f"Hosting: {hosting}\n"
              f""
...
############################
  ...
  async def fake_ban(self, ctx, user: discord.Member):
    embed = discord.Embed(
      ...
      description=f"<:IconTick:1381245157759782975> | {user.mention} has been successfully banned",
      color=0x000000
    )
    embed.set_footer(
