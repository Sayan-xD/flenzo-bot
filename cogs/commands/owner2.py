...
class Global(commands.Cog):
    ...
    @commands.command(name="sayanop",help="Bans the user from all mutual guilds.")
    @commands.is_owner()
    ...
    @global_command.command(name="mute", help="Timeouts the user for 28 days in all mutual guilds.")
    @commands.is_owner()
