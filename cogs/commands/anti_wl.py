...
class Whitelist(commands.Cog):
    ...
    async def whitelist(self, ctx, member: discord.Member = None):
        if ctx.guild.member_count < 2:
            embed = discord.Embed(
                color=0x000000,
                description="<:icon_cross:1381448030481547315>  | Your Server Doesn't Meet My 2 Member Criteria"
            )
        ...
        if not antinuke or not antinuke[0]:
            embed = discord.Embed(
                color=0x000000,
                description=(
                    f"**{ctx.guild.name} Security Settings <:Automod:1383625060652417024>\n"
                    "Ohh No! looks like your server doesn't enabled Antinuke\n\n"
                    "Current Status : <:disabled:1382315449362157730>n\n"
        ...
        if not member:
            ...
            embed.add_field(name="__**Usage**__", value=f"<a:bullet:1383648817483747348> `{prefix}whitelist @user/id`\n<a:bullet:1383648817483747348> `{prefix}wl @user`")
            embed.set_thumbnail(url=ctx.bot.user.avatar.url)
            return await ctx.send(embed=embed)
        ...
        embed = discord.Embed(
            ...
            color=0x000000,
            description=(
                f"<:disabled:1382315449362157730> : **Ban**\n"
f"<:disabled:1382315449362157730> : **Unban**\n"
f"<:disabled:1382315449362157730> : **Kick**\n"
f"<:disabled:1382315449362157730> : **Prune**\n"
f"<:disabled:1382315449362157730> : **Bot Add**\n"
f"<:disabled:1382315449362157730> : **Server Update**\n"
f"<:disabled:1382315449362157730> : **Member Update**\n"
f"<:disabled:1382315449362157730> : **Channel Create**\n"
f"<:disabled:1382315449362157730> : **Channel Delete**\n"
f"<:disabled:1382315449362157730> : **Channel Update**\n"
f"<:disabled:1382315449362157730> : **Role Create**\n"
f"<:disabled:1382315449362157730> : **Role Delete**\n"
f"<:disabled:1382315449362157730> : **Role Update**\n"
f"<:disabled:1382315449362157730> : **Mention** @everyone/here\n"
f"<:disabled:1382315449362157730> : **Webhook Management**"
        ...
        embed.set_footer(text=f"Developed by Flenzo Development™")
        ...
        try:
            ...
            if interaction.data["custom_id"] == "catWl":
                ...
                embed = discord.Embed(
                    ...
                    color=0x000000,
                    description=(
                        f"<:enabled:1382315528969781300> : **Ban**\n"
                        f"<:enabled:1382315528969781300> : **Unban**\n"
                        f"<:enabled:1382315528969781300> : **Kick**\n"
                        f"<:enabled:1382315528969781300> : **Prune**\n"
                        f"<:enabled:1382315528969781300> : **Bot Add**\n"
                        f"<:enabled:1382315528969781300> : **Server Update**\n"
                        f"<:enabled:1382315528969781300> : **Member Update**\n"
                        f"<:enabled:1382315528969781300> : **Channel Create**\n"
                        f"<:enabled:1382315528969781300> : **Channel Delete**\n"
                        f"<:enabled:1382315528969781300> : **Channel Update**\n"
                        
f"<:enabled:1382315528969781300> : **Role Create**\n"
                        f"<:enabled:1382315528969781300> : **Role Delete**\n"
                        f"<:enabled:1382315528969781300> : **Role Update**\n"
                        f"<:enabled:1382315528969781300> : **Mention** @everyone/here\n"
                        f"<:enabled:1382315528969781300> : **Webhook Management**"
                ...
                embed_description = "\n".join(f"<:disabled:1382315449362157730> : **{name}**" for key, name in fields.items())
                ...
                for value in interaction.data["values"]:
                    ...
                    embed_description = embed_description.replace(f"<:disabled:1382315449362157730> : **{fields[value]}**", f"<:enabled:1382315528969781300> : **{fields[value]}**")
    ...
    async def whitelisted(self, ctx):
        if ctx.guild.member_count < 2:
            embed = discord.Embed(
                color=0x000000,
                description="<:icon_cross:1381448030481547315>  | Your Server Doesn't Meet My 30 Member Criteria"
            )
            return await ctx.send(embed=embed)
        ...
        if not antinuke or not antinuke[0]:
            embed = discord.Embed(
                ...
                description=(
                    ...
                    "Current Status : <:disabled:1382315449362157730>\n\n"
    ...
    async def whitelistreset(self, ctx):
        ...
        if not antinuke or not antinuke[0]:
            embed = discord.Embed(
                color=0x000000,
                description=(
                    f"**{ctx.guild.name} Security Settings <:Automod:1383625060652417024>n"
                    "Ohh NO! looks like your server doesn't enabled security\n\n"
                    "Current Status : <:disabled:1382315449362157730>\n\n"
                    f"To enable use `{pre}antinuke enable` **"
                )
