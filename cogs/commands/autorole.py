...
class AutoRole(commands.Cog):
    ...
    async def _ar_config(self, ctx):
        ...
        if data:
            ...
            emb.add_field(name="<:roledranzer:1381158073262932028>  __Humans__", value=hums, inline=False)
            emb.add_field(name="<:Automod:1383625060652417024>  __Bots__", value=bos, inline=False)
