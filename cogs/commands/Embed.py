    ...
    async def _embed(self, ctx):
        ...
        async def send_callback(interaction):
            ...
            try:
                ...
                await ctx.send(embed=discord.Embed(title="<:IconTick:1381245157759782975> Success",
        ...
        button_send = Button(label="Send Embed",  emoji="<:IconTick:1381245157759782975>", style=discord.ButtonStyle.success)
        button_send.callback = send_callback

        button_delete = Button(label="Cancel Setup",  emoji="<:icon_cross:1381448030481547315>", style=discord.ButtonStyle.danger)
